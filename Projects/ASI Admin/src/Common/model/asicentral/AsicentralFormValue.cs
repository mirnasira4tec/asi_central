...
namespace asi.asicentral.model.asicentral
{
    public class AsicentralFormValue
    {
        ...
        public static readonly string[] CC_Lables = { CC_HOLDER_NAME, CC_TYPE, CC_NUMBER, CC_EXP_MONTH, CC_EXP_YEAR,
            CC_TOKEN_ID, CC_AUTH_REFERENCE, CC_ADDRESS, CC_CITY, CC_STATE, CC_POSTALCODE, CC_COUNTRY};

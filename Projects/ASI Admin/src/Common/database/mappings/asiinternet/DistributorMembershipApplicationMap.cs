...
{
    public class LegacyDistributorMembershipApplicationMap : EntityTypeConfiguration<DistributorMembershipApplication>
    {
        public LegacyDistributorMembershipApplicationMap()
        {

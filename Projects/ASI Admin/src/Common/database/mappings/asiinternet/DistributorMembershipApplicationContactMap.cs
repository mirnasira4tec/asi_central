...
{
    public class LegacyDistributorMembershipApplicationContactMap : EntityTypeConfiguration<DistributorMembershipApplicationContact>
    {
        public LegacyDistributorMembershipApplicationContactMap()
        {

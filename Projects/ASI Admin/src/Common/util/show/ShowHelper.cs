...
namespace asi.asicentral.util.show
{
    public static class ShowHelper
    {
        ...
        public static ShowProfileRequests CreateOrUpdateProfileRequests(IObjectService objectService, ShowProfileRequests objProfileRequests)
        {
            if (objProfileRequests == null) return null;
            ShowProfileRequests profileRequests = null;
            if (objProfileRequests.Id == 0)
            {
            ...
            {
                profileRequests = objectService.GetAll<ShowProfileRequests>().Where(ctxt => ctxt.Id == objProfileRequests.Id).SingleOrDefault();
            }
            profileRequests.AttendeeId = objProfileRequests.AttendeeId;
            profileRequests.EmployeeAttendeeId = objProfileRequests.EmployeeAttendeeId;
            profileRequests.RequestedBy = objProfileRequests.RequestedBy;
            profileRequests.Status = objProfileRequests.Status;
            profileRequests.UpdateDate = DateTime.UtcNow;
            profileRequests.UpdateSource = objProfileRequests.UpdateSource;
            return profileRequests;
        }

        public static ShowProfileRequiredData CreateOrUpdateProfileRequiredData(IObjectService objectService, ShowProfileRequiredData objProfileRequiredData)
        {
            if (objProfileRequiredData == null) return null;
            ShowProfileRequiredData ProfileRequiredData = null;
            if (objProfileRequiredData.Id == 0)
            {
                ...
                try
                {
                    objectService.Add<ShowProfileRequiredData>(ProfileRequiredData);
                }
                catch (Exception ex)
                {
                    throw ex;
            ...
            {
                ProfileRequiredData = objectService.GetAll<ShowProfileRequiredData>().Where(ctxt => ctxt.Id == objProfileRequiredData.Id).SingleOrDefault();
            }
            ProfileRequiredData.ProfileRequestId = objProfileRequiredData.ProfileRequestId;
            ProfileRequiredData.Email = objProfileRequiredData.Email;
            ProfileRequiredData.CompanyName = objProfileRequiredData.CompanyName;
            ProfileRequiredData.ASINumber = objProfileRequiredData.ASINumber;
            ProfileRequiredData.AttendeeName = objProfileRequiredData.AttendeeName;
            ProfileRequiredData.AttendeeTitle = objProfileRequiredData.AttendeeTitle;
            ProfileRequiredData.AttendeeCommEmail = objProfileRequiredData.AttendeeCommEmail;
            ProfileRequiredData.AttendeeCellPhone = objProfileRequiredData.AttendeeCellPhone;
            ProfileRequiredData.AttendeeWorkPhone = objProfileRequiredData.AttendeeWorkPhone;
            ProfileRequiredData.CorporateAddress = objProfileRequiredData.CorporateAddress;
            ProfileRequiredData.City = objProfileRequiredData.City;
            ProfileRequiredData.State = objProfileRequiredData.State;
            ProfileRequiredData.Zip = objProfileRequiredData.Zip;
            ProfileRequiredData.CompanyWebsite = objProfileRequiredData.CompanyWebsite;
            ProfileRequiredData.ProductSummary = objProfileRequiredData.ProductSummary;
            ProfileRequiredData.TrustFromDistributor = objProfileRequiredData.TrustFromDistributor;
            ProfileRequiredData.SpecialServices = objProfileRequiredData.SpecialServices;
            ProfileRequiredData.LoyaltyPrograms = objProfileRequiredData.LoyaltyPrograms;
            ProfileRequiredData.Samples = objProfileRequiredData.Samples;
            ProfileRequiredData.ProductSafety = objProfileRequiredData.ProductSafety;
            ProfileRequiredData.FactAboutCompany = objProfileRequiredData.FactAboutCompany;
            ProfileRequiredData.UpdateDate = DateTime.UtcNow;
            ProfileRequiredData.UpdateSource = objProfileRequiredData.UpdateSource;
            return ProfileRequiredData;
        }

        public static ShowProfileRequestOptionalDetails CreateOrUpdateProfileRequestOptionalDetails(IObjectService objectService, ShowProfileRequestOptionalDetails objProfileRequestOptionalDetails)
        {
            if (objProfileRequestOptionalDetails == null) return null;
            ShowProfileRequestOptionalDetails ProfileRequestOptionalDetails = null;
            if (objProfileRequestOptionalDetails.Id == 0)
            {
                ...
                try
                {
                    objectService.Add<ShowProfileRequestOptionalDetails>(ProfileRequestOptionalDetails);
                }
                catch (Exception ex)
                {
                    throw ex;
            ...
            {
                ProfileRequestOptionalDetails = objectService.GetAll<ShowProfileRequestOptionalDetails>().Where(ctxt => ctxt.Id == objProfileRequestOptionalDetails.Id).SingleOrDefault();
            }
            ProfileRequestOptionalDetails.ProfileRequestId = objProfileRequestOptionalDetails.ProfileRequestId;
            ProfileRequestOptionalDetails.ProfileOptionalDataLabelId = objProfileRequestOptionalDetails.ProfileOptionalDataLabelId;
            ProfileRequestOptionalDetails.UpdateValue = objProfileRequestOptionalDetails.UpdateValue;
            ProfileRequestOptionalDetails.OrigValue = objProfileRequestOptionalDetails.OrigValue;
            ProfileRequestOptionalDetails.UpdateDate = DateTime.UtcNow;
            ProfileRequestOptionalDetails.UpdateSource = objProfileRequestOptionalDetails.UpdateSource;
            return ProfileRequestOptionalDetails;
        }

namespace asi.asicentral.util.store
{
	public static class SalesFormHelper
	{
		public static readonly string[,] PRODUCTS = { { "ESP Website", "ESPW-60" }, { "Additional ESP License", "ESPL-60" }, { "Company Store", "CPYS-49.99" }, 
			{ "Distributor Membership", "DIST-29.99" }, {"Distributor Package – Basic","DIST-149.99"}, {"Distributor Package - Standard","DIST-199.99"}, {"Distributor Package – Executive","DIST-229.99"}, {"Distributor Package - Premium","DIST-299.99"},

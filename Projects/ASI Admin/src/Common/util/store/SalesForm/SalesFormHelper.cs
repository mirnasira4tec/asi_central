namespace asi.asicentral.util.store
{
	public static class SalesFormHelper
	{
		public static readonly string[,] PRODUCTS = { 
            ...
            { "Distributor Package - Standard", "DIST-199.99", "Distributor Membership" },
            { "Distributor Package – Executive", "DIST-229.99", "Distributor Membership" }, 
            { "Distributor Package - Premium", "DIST-299.99", "Distributor Membership" },

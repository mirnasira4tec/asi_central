...
namespace asi.asicentral.services
{
    public class ROIService : IROIService
    {
        ...
        private Category[] GetImpressionsPerCategoryTemplate()
        {
            ...
            categories[0] = new Category() { Name = "BABY ITEMS", SupplierCount = 217 };
            categories[0].Results = new Company[6];
            ...
            categories[0].Results[5] = new Company() { IsRequestor = true, Impressions = 35, Rank = 81 };
            categories[0].Requestor = categories[0].Results[5];

            categories[1] = new Category() { Name = "BASEBALL CAPS", SupplierCount = 357 };
            categories[1].Results = new Company[6];
            ...
            categories[1].Results[5] = new Company() { IsRequestor = true, Impressions = 272, Rank = 66 };
            categories[1].Requestor = categories[1].Results[5];

            categories[2] = new Category() { Name = "GOLF/POLO SHIRTS", SupplierCount = 262 };
            categories[2].Results = new Company[6];
            ...
            categories[2].Results[5] = new Company() { IsRequestor = true, Impressions = 919, Rank = 31 };
            categories[2].Requestor = categories[2].Results[5];
            return categories;
        }
    }
}

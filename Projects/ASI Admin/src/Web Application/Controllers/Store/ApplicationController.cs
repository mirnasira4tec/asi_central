...
namespace asi.asicentral.web.Controllers.Store
{
    public class ApplicationController : Controller
    {
        ...
        public virtual ActionResult EditDistributor(DistributorApplicationModel application)
        {
            ...
            return ProcessCommand(StoreService, order, application.Id, application.ActionName);
        }
        ...
        /// <returns></returns>
        private ActionResult ProcessCommand(IStoreService storeService, Order order, Guid applicationId, string command)
        {

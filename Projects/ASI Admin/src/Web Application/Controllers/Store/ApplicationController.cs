...
namespace asi.asicentral.web.Controllers.Store
{
    ...
    public class ApplicationController : Controller
    {
        ...
        public virtual ActionResult Edit(int id)
        {
            ...
            {
                if (orderDetail.Product != null && orderDetail.Product.Type == "Product" && orderDetail.MagazineSubscriptions != null && orderDetail.MagazineSubscriptions.Count > 0) return View("../Store/Application/Magazines", new MagazinesApplicationModel(orderDetail));
                else throw new Exception("Retieved an unknown type of application");
            }
        }

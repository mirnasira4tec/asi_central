...
namespace asi.asicentral.web.Controllers.Store
{
    ...
    public class ApplicationController : Controller
    {
        ...
        public static readonly int[] ORDERDETAIL_PRODUCT_IDS = { 29, 30, 31, 45, 46, 55, 56, 57, 58, 59, 60, 62, 70, 71, 77, 78, 96, 97, 98, 100, 101, 102, 104, 105, 106, 107, 108, 109, 112, 113, 116, 117, 121, 122, 123, 124, 155 };
